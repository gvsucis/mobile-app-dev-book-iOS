    ...
    //  TraxyApp
    //
    //  Created by Jonathan Engelsma on 12/31/20.
    ...
    class AudioViewController: UIViewController {
        ...
        override func viewDidLoad() {
            ...
            if self.entry == nil  {
                self.entry = JournalEntry(key: nil, type: .audio, caption: "", url: "",
                                          thumbnailUrl: "", date: Date(), lat: 0.0, lng: 0.0)
            }
        ...
        {
            let avc = UIAlertController(title: "Mic Permission Required", message: "You need to provide this app permissions to use your microphone for this feature. You can do this by going to your Settings app and going to Privacy -> Microphone",
        ...
        func setSessionPlayback() {
            ...
            do {
                try session.setCategory(
                    AVAudioSession.Category(rawValue: AVAudioSession.Category.playback.rawValue))
            } catch let error as NSError {
                print(error.localizedDescription)
            }
            do {
